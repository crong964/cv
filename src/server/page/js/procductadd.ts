var tableChildpro = () => {
    let dataForm = document.getElementById("form") as HTMLFormElement;
    let form;
    if (dataForm) {
    ...
    let bt1: any = form?.get("bt1")
    let dsbt1: any = form?.getAll("dsbt1[]")
    let bt2: any = form?.get("bt2")
    let dsbt2: any = form?.getAll("dsbt2[]")
    if (!bt1 && !dsbt1) {
        return
    }
    var head = `
    ...
    head += body
    var ta = document.querySelector(".table") as HTMLElement
    ta.innerHTML = head
...
var btmot = () => {
    ...
    var bt1 = document.querySelector(".bt1") as HTMLElement
...
var bthai = () => {
    ...
    var bt2 = document.querySelector(".bt2") as HTMLElement
    var div = document.createElement('div')
...
var preview = (id: string) => {
    var fileReader = new FileReader
    var file = document.getElementById(id) as HTMLInputElement
    var chage = document.getElementById(`chage${id}`) as HTMLInputElement
    if (chage) {
        chage.value = "1"
    }
    fileReader.onload = () => {
        var image = document.getElementById("image" + id) as HTMLImageElement
